...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    for(double variableX = -20.0; variableX<20.0; variableX += 0.15){
...
void MainWindow::drawPoints(){
    series->clear();
    for(double variableX = -20.0; variableX<20.0; variableX += 0.15, MainWindow::incrementX +=0.001){
...
{
    ui->label_2->setText("x = " + QString::number(point.x()) + " y = " + QString::number(point.y()));
}
